...
export const addToState = (key: string) => (value: unknown) => _internalState.set(key, value)
export const getFromState = <T>(key: string) => _internalState.get(key) as T | undefined
